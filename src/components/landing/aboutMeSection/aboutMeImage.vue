<template>
    <div class="h-[500px] w-[300px] relative">
        ...
        <div
            class="h-[500px] w-[250px] bg-orange ring-3 ring-cyan absolute bottom-[-30px] left-[-30px] rounded-bl-[120px] rounded-tr-[120px] rounded-br-[20px] rounded-tl-[20px] -z-10">
        </div>
    </div>
</template>